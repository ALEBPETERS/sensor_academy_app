                    ...
                    <div className="space-y-3 text-xs">
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full bg-slate-955 border border-slate-800 p-2.5 rounded-lg text-white text-xs outline-none"
                        />
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full bg-slate-955 border border-slate-800 p-2 text-white text-xs outline-none"
                        />
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <select
                          ...
                          className="w-full bg-slate-955 border border-slate-800 p-2 rounded text-white outline-none"
                        >
