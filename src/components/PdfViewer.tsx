              ...
              return (
                ...
                >
                  ...
                  <div className="bg-slate-850/80 px-5 py-3.5 border-b border-slate-800 flex justify-between items-center bg-gradient-to-r from-slate-900 via-slate-850 to-slate-900">
                    ...
                    <span className="text-xs bg-slate-805 text-slate-400 font-mono py-0.5 px-2 rounded-full border border-slate-700">
                  ...
                  {/* Question Prompt */}
                  <div className="p-5">
                    <div className="bg-slate-950 p-4 border border-slate-800 rounded-xl leading-relaxed text-sm whitespace-pre-wrap font-sans text-slate-150">
